        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              ...
              excepcionais e inovadoras que conectam pessoas e ideias.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Desenvolvimento Front-end</li>
              <li className="text-gray-400">Aplicações Web</li>
              <li className="text-gray-400">Sites Responsivos</li>
              <li className="text-gray-400">Otimização de Performance</li>
              <li className="text-gray-400">Consultoria Técnica</li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-center md:text-left mb-4 md:mb-0">
              ...
              <p className="text-gray-500 text-sm mt-1">
                Feito com <Heart className="inline w-4 h-4 text-red-500" /> e
                muito código
              </p>
            </div>
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center space-x-2 text-gray-400 hover:text-primary-400 transition-colors duration-300 p-3 hover:bg-dark-800 rounded-lg">
